...
#SBATCH --job-name=B240_imm_seq
#SBATCH --output=/scratch/nc1827/leaf_splitting/logs/B240_seq_%A_%a.out
#SBATCH --error=/scratch/nc1827/leaf_splitting/logs/B240_seq_%A_%a.err
#SBATCH --time=2:00:00                       # 2 hours per task (289M insertions)
...
RUN_DIR="$ROOT_DIR/runs/Var_R/B240_immediately_r1-240_seq10k"
