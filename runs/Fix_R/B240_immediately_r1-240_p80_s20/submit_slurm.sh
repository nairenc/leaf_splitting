...
#SBATCH --job-name=immediately_sweep_B240
#SBATCH --output=/scratch/nc1827/leaf_splitting/logs/B240_imm_p80_sweep_%A_%a.out
#SBATCH --error=/scratch/nc1827/leaf_splitting/logs/B240_imm_p80_sweep_%A_%a.err
...
RUN_DIR="$ROOT_DIR/runs/Fix_R/B240_immediately_r1-240_p80_s20"
