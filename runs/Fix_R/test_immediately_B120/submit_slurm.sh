...
#SBATCH --job-name=test_imm_B120
#SBATCH --output=/scratch/nc1827/leaf_splitting/logs/test_imm_B120_%A_%a.out
#SBATCH --error=/scratch/nc1827/leaf_splitting/logs/test_imm_B120_%A_%a.err
...
RUN_DIR="$ROOT_DIR/runs/Fix_R/test_immediately_B120"
