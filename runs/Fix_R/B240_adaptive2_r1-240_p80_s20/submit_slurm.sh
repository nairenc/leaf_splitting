...
#SBATCH --job-name=adaptive2_sweep_B240
#SBATCH --output=/scratch/nc1827/leaf_splitting/logs/B240_adp2_p80_sweep_%A_%a.out
#SBATCH --error=/scratch/nc1827/leaf_splitting/logs/B240_adp2_p80_sweep_%A_%a.err
...
RUN_DIR="$ROOT_DIR/runs/Fix_R/B240_adaptive2_r1-240_p80_s20"
